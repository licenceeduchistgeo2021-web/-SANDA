          ...
          <div className="flex justify-center items-center gap-4 md:gap-8 mb-6">
            ...
            <div className='flex flex-col gap-2'>
              ...
              <p className="text-xs md:text-sm text-muted-foreground max-w-4xl mx-auto">
                رسالة الماستر:  تدبير مخاطر الكوارث الطبيعية بعمالات (عين السبع
                ...
                <CardContent className="space-y-6 pt-4">
                    ...
                    <div className="bg-muted/50 p-6 rounded-xl border border-dashed">
                        ...
                        <p className="text-sm leading-relaxed text-muted-foreground">
                            تندرج هذه المنصة في إطار بحث أكاديمي لنيل شهادة الماستر في "هنة تدبير مخاطر الكوارث الطبيعية". تهدف الأداة إلى توفير قاعدة بيانات رقمية تساعد صناع القرار في عمالات (سيدي البرنوصي، المحمدية، وعين السبع) على تحديد فجوات الصمود وتوجيه الاستثمارات الوقائية بشكل فعال، انتقالاً من مرحلة رد الفعل إلى مرحلة التخطيط الاستباقي وإعادة الإعمار المرنة.
                        </p>
                    </div>
                </CardContent>
            </Card>
